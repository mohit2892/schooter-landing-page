...
<!-- Hero Section -->
<section class="relative min-h-screen flex items-center justify-center bg-cover bg-center" style="background-image: url('{{ asset('build/assets/img/hero-bg.jpg') }}');">
  ...
  <div class="max-w-6xl mx-auto px-6">
    ...
    <div class="text-center mb-12">
      ...
      <p class="mt-4 text-gray-700">
        "Electricsscooterbook," which is designed to promote natural cause an electric , <br><span> scooter, has big aims. Bring it home right now.</span> 
      </p>
    </div>
    ...
    <div class="md:grid md:grid-cols-2 gap-10 items-center">
      <!-- Image Section -->
      <div class="relative">
        <img src="{{ asset('build/assets/img/about-sec.png') }}" alt="Electric Scooter" class="rounded-lg shadow-lg">
      ...
      <!-- Text Section -->
      <div>
        <h3 class="text-2xl font-Fredoka mb-4" style="font-family: 'Poppins', sans-serif;">Welcome To Electric Scooter</h3>
        ...
        <!-- Contact Button -->
        <a href="#contact" class="mt-6 inline-block bg-green-600 text-white px-6 py-2 rounded shadow hover:bg-green-700 transition-all duration-300">
          Contact Us
        </a>
      </div>
    </div>
  ...
  <div class="max-w-6xl mx-auto px-6">
    ...
    <div class="grid md:grid-cols-3 gap-10 text-center">
      ...
      <div class="p-6 bg-white rounded-lg hover:shadow-lg transition duration-300">
        <img src="{{ asset('build/assets/img/services/service-1.png') }}" alt="Eco Friendly" class="h-14 mx-auto mb-4">
        <h4 class="font-Fredoka mb-2">ECO-FRIENDLY</h4>
        <p class="text-gray-600">
          Electric scooters emit nearly little pollution. Electric scooters have been among the front-runners thus far.
        </p>
      </div>

      <!-- Feature 2 -->
      <div class="p-6 bg-white rounded-lg hover:shadow-lg transition duration-300">
          <img src="{{ asset('build/assets/img/services/service-2.png') }}" alt="Powerful Brakes" class="h-14 mx-auto mb-4">
          <h4 class="font-Fredoka mb-2">POWERFUL BRAKES</h4>
          <p class="text-gray-600">
            The regenerative braking mechanism has been improved so that experienced riders can ride without using the disc brakes.
          </p>
      </div>

      <!-- Feature 3 -->
      <div class="p-6 bg-white rounded-lg hover:shadow-lg transition duration-300">
        <img src="{{ asset('build/assets/img/services/service-3.png') }}" alt="Powerful Batteries" class="h-14 mx-auto mb-4">
        <h4 class="font-Fredoka mb-2">POWERFUL BATTERIES</h4>
        <p class="text-gray-600">
          Electric scooters use three types of batteries: sealed lead acid, nickel-metal hydride, and lithium-ion.
        </p>
      </div>

      <!-- Feature 4 -->
      <div class="p-6 bg-white rounded-lg hover:shadow-lg transition duration-300">
        <img src="{{ asset('build/assets/img/services/service-4.png') }}" alt="Cruise Control" class="h-14 mx-auto mb-4">
        <h4 class="font-Fredoka mb-2">CRUISE CONTROL</h4>
        <p class="text-gray-600">
          Cruise control is one of the numerous modern technologies available on electric scooters. It can be activated with a single button press.
        </p>
      </div>

      <!-- Feature 5 -->
      <div class="p-6 bg-white rounded-lg hover:shadow-lg transition duration-300">
        <img src="{{ asset('build/assets/img/services/service-5.png') }}" alt="BLDC" class="h-14 mx-auto mb-4">
        <h4 class="font-Fredoka mb-2">BLDC</h4>
        <p class="text-gray-600">
          This is one example of the cutting-edge technology offered on electric scooters. With a single button press, you can activate cruise control.
        </p>
      </div>

      <!-- Feature 6 -->
      <div class="p-6 bg-white rounded-lg hover:shadow-lg transition duration-300">
        <img src="{{ asset('build/assets/img/services/service-6.png') }}" alt="A Fantastic Ride" class="h-14 mx-auto mb-4">
        <h4 class="font-Fredoka mb-2">A FANTASTIC RIDE</h4>
        <p class="text-gray-600">
          Compared to gasoline scooters, electric scooters provide a better riding experience with a quiet, vibration-free ride and quick torque.
        </p>
      </div>
    </div>
  </div>
...
<!-- Counter Section -->
<section
  class="relative  bg-center bg-no-repeat bg-fixed py-16 text-white"
      ...
      <div >
        <div class="text-green-500 mb-2 flex justify-center">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="currentColor" viewBox="0 0 24 24">
            <path d="M3 6a3 3 0 1 1 6 0 3 3 0 0 1-6 0zm12 0a3 3 0 1 1 6 0 3 3 0 0 1-6 0zM6 9h6v2H6v2h3a3 3 0 0 1 3 3v4h-2v-4a1 1 0 0 0-1-1H6v-2H3v-2h3V9zm12 2h3v2h-3v2h-3a1 1 0 0 0-1 1v4h-2v-4a3 3 0 0 1 3-3h3v-2z"/>
          </svg>
        </div>
        ...
        <div>
          <div class="text-green-500 mb-2 flex justify-center">
            <!-- Car Icon -->
            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="currentColor" viewBox="0 0 24 24">
              <path d="M5 11l1-3h12l1 3h1a1 1 0 0 1 1 1v7h-2v-2H5v2H3v-7a1 1 0 0 1 1-1h1zm2.5 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zm11 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"/>
            </svg>
          </div>
          ...
          <div>
            <div class="text-green-500 mb-2 flex justify-center">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 1a9 9 0 0 0-9 9v5a4 4 0 0 0 4 4h1v-6H5v-3a7 7 0 0 1 14 0v3h-3v6h1a4 4 0 0 0 4-4v-5a9 9 0 0 0-9-9z"/>
              </svg>
            </div>
    ...
    <section id="reviews" class="py-16 bg-white">
      <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
          ...
          <!-- Left Image -->
          <div>
            <img src="{{ asset('build/assets/img/testimonial-sec.png') }}" alt="Scooter" class="mx-auto max-w-full" />
          </div>
          ...
          <div class="relative overflow-hidden">
            <div id="testimonial-slider" class="flex transition-transform duration-500 ease-in-out">
              ...
              <div class="min-w-full bg-black p-8 rounded-lg shadow-lg text-white flex flex-col">
                <div class="border-4 border-green-600 rounded-full w-20 h-20 overflow-hidden mb-4">
                  <img src="{{ asset('build/assets/img/testimonials/1.png') }}" alt="User 1" class="object-cover w-full h-full" />
                </div>
                <p class="text-sm leading-relaxed mb-4">
                  I was looking for an electric scooter franchise when I came across an enticing business opportunity to start one. Now that I have it, all I can say is a big thank you to the Book Electric Scooter team for assisting me with the franchise.
                </p>
                <div>
              ...
              <div class="min-w-full bg-black p-8 rounded-lg shadow-lg text-white flex flex-col">
                <div class="border-4 border-green-600 rounded-full w-20 h-20 overflow-hidden mb-4">
                  <img src="{{ asset('build/assets/img/testimonials/2.png') }}" alt="User 2" class="object-cover w-full h-full" />
                </div>
                <p class="text-sm leading-relaxed mb-4">
                  I was looking for an electric scooter franchise when I came across an enticing business opportunity to start one. Now that I have it, all I can say is a big thank you to the Book Electric Scooter team for assisting me with the franchise.
                </p>
              ...
              <div class="min-w-full bg-black p-8 rounded-lg shadow-lg text-white flex flex-col">
                <div class="border-4 border-green-600 rounded-full w-20 h-20 overflow-hidden mb-4">
                  <img src="{{ asset('build/assets/img/testimonials/3.png') }}" alt="User 3" class="object-cover w-full h-full" />
                </div>
                <p class="text-sm leading-relaxed mb-4">
                  I was looking for an electric scooter franchise when I came across an enticing business opportunity to start one. Now that I have it, all I can say is a big thank you to the Book Electric Scooter team for assisting me with the franchise.
                </p>
            ...
            <!-- Dots -->
            <div class="absolute bottom-4 right-4 flex space-x-2">
              <span class="dot w-3 h-3 bg-black border-2 border-green-500 rounded-full cursor-pointer" data-index="0"></span>
              <span class="dot w-3 h-3 bg-black border-2 border-green-500 rounded-full cursor-pointer" data-index="1"></span>
              <span class="dot w-3 h-3 bg-black border-2 border-green-500 rounded-full cursor-pointer" data-index="2"></span>
            </div>
